<?php
/**
 * Order success page — place this file in: public/order-success.php
 */
...
$order = null;
if ($orderNo !== '') {
    $order = Database::fetch("SELECT * FROM orders WHERE order_number = ?", array($orderNo));
}
...
<div class="container text-center" style="max-width:520px">
  ...
  <?php if ($orderNo): ?>
  <p class="text-muted" style="font-size:1.1rem;margin-bottom:8px">
    Order Number: <strong style="color:var(--color-text)"><?= e($orderNo) ?></strong>
  </p>
  <?php endif; ?>
